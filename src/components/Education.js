                ...
                <div className="education">
                    <h1 className="education-subject">Obrazovanje</h1>
                        <div className="education-boxItem">
                            <a href="https://itbootcamp.rs/" target="_blank" rel="noreferrer" className="education-boxItemTitle"><h2>IT BOOTCAMP</h2></a>
                            <h4 className="education-boxItemSubtitle">Razvoj Web aplikacija (JS)</h4>
                            <div className="time">Januar - Maj 2020</div>
                        </div>
                        <div className="education-boxItem">
                            <a href="https://www.it-akademija.com/" target="_blank" rel="noreferrer" className="education-boxItemTitle"><h2>IT ACADEMY</h2></a>
                            <h4 className="education-boxItemSubtitle">3D Dizajn i CAD</h4>
                            <div className="time">Septembar 2019 - Jul 2020</div>
                        </div>
                        <div className="education-boxItem">
                            <a href="http://www.sfb.bg.ac.rs/" target="_blank" rel="noreferrer" className="education-boxItemTitle"><h2>ŠUMARSKI FAKULTET</h2></a>
                        ...
                        <div className="education-boxItem">
                            <a href="http://gimnazijabb.edu.rs/" target="_blank" rel="noreferrer" className="education-boxItemTitle"><h2>GIMNAZIJA ''JOSIF PANČIĆ''</h2></a>
